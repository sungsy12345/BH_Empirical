...
rmarkdown::render(here("1_Codes", "8B_Stage_BH.Rmd"),        output_file = sprintf("Main_Results_%s_Full_RandomTie.pdf", today_str), output_dir = here("2_Reports"), intermediates_dir = tempdir())
rmarkdown::render(here("1_Codes", "8C_Dynamic_BH.Rmd"),        output_file = sprintf("TwoStage_%s.pdf", today_str), output_dir = here("2_Reports"), intermediates_dir = tempdir())
